...
function calDivLatlang(){
    ...
    $.each(all_overlays, function( key, value ) {
        ...
        if(value.center == undefined){
            ...
            var lagLatAndRad =  "<div class='locPush' style='cursor: pointer;' id="+id+"><div class='pull-right' ><a href='javascript:;' id="+delID+" >X</a ></div><b>Latitude :</b> <span class='pdltmg5'> "+value.overlay.center.lat().toFixed(6)+"</span><b>Longitude :</b><span class='pdlt5'>"+value.overlay.center.lng().toFixed(6)+"</span><div style='margin-top:7px;'><b>Radius :</b><span class='pdltmg5'>"+overlayR+" KM</span></div></div><br>"
        ...
        else
        {
            ...
            var lagLatAndRad = "<div class='locPush' style='cursor: pointer;' id="+id+" ><div class='pull-right' ><a href='javascript:;' id="+delID+">X</a></div><b>Latitude :</b> <span class='pdltmg5'> "+value.center.lat().toFixed(6)+"</span><b>Longitude :</b><span class='pdlt5'>"+value.center.lng().toFixed(6)+"</span><div style='margin-top:7px;'><b>Radius :</b><span class='pdltmg5'>"+valueR+" KM</span></div></div><br>"
            $("#addLangLat").append(lagLatAndRad)
...
function changeLocBySelect(e){
	...
	//console.log("@@__multiMap__multiMap@",__multiMap)
