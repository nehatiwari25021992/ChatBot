...
<div class="widget widget-blue" id="manageIntentWidget">
          ...
          <div class="col-sm-12 mrbt10">
            <div class="pull-right">
              <button class="btn btn-default btn btn-default-blue btn-sm"
                      type="button" ng-click="goToAddIntent()">
...
<!--              <th >Description</th>-->
          ...
          <tbody>
            <tr ng-repeat="intent in intentList | limitTo: limit" >
...
<!--              <td valign="top" class="wbAll">{{intent.description}}</td>-->
          ...
          <tbody ng-show="intentList.length =='0'">
            <tr>
              <td colspan="4" align="center"><div class="noRecords">No
                  Intent(s) found.</div></td>
            </tr>
          </tbody>
        </table>
      </div>
      <div class="row" ng-show="intentList.length !='0'">
